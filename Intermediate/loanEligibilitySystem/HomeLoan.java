...
/**
 * This class represents a home loan, which may have a lower interest rate but
 * requires higher credit scores for eligibility.
 */
public class HomeLoan extends Loan {
    ...
    public void calculateEligibility(Customer customer)
        ...
        //Check if the credit score is outside the valid range (650 to 900)
        if (customer.getCreditScore() < 650 || customer.getCreditScore() > 900) {
            throw new InvalidCreditScoreException("Credit score must be between 650 and 900");
        }
