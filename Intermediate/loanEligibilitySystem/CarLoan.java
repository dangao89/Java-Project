...
/**
 * The class represents a car loan.
 */
public class CarLoan extends Loan {

    //Initialize the loan amount, interest rate, and loan term
    public CarLoan(double loanAmount, double interestRate, int loanTerm) {
    ...
    public void calculateEligibility(Customer customer)
        ...
        //Check if the credit score is outside the valid range (500 to 900)
        if (customer.getCreditScore() < 500 || customer.getCreditScore() > 900) {
            throw new InvalidCreditScoreException("Credit score must be between 500 and 900");
        }
